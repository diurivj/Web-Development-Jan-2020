 ...
 * @api private
 */
e.isMongooseObject=function(t){return m||(m=r(6)),v||(v=r(23).Array),_||(_=r(23).Buffer),null!=t&&(null!=t.$__||t.isMongooseArray||t.isMongooseBuffer||t.$isMongooseMap)};var A=e.isMongooseObject;
/*!
 ...
 * Decorate buffers
 */
e.decorate=function(t,e){for(var r in e)g.has(r)||(t[r]=e[r])},e.mergeClone=function(t,r){A(r)&&(r=r.toObject({transform:!1,virtuals:!1,depopulate:!0,getters:!1,flattenDecimals:!1}));for(var n=Object.keys(r),i=n.length,o=0,s=void 0;o<i;)if(s=n[o++],!g.has(s))if(void 0===t[s])t[s]=e.clone(r[s],{transform:!1,virtuals:!1,depopulate:!0,getters:!1,flattenDecimals:!1});else{var a=r[s];if(null==a||!a.valueOf||a instanceof Date||(a=a.valueOf()),e.isObject(a)){var u=a;A(a)&&!a.isMongooseBuffer&&(u=u.toObject({transform:!1,virtuals:!1,depopulate:!0,getters:!1,flattenDecimals:!1})),a.isMongooseBuffer&&(u=d.from(u)),e.mergeClone(t[s],u)}else t[s]=e.clone(a,{flattenDecimals:!1})}},e.each=function(t,e){for(var r=0;r<t.length;++r)e(t[r])},
/*!
 * ignore
 */
 ...
 * ignore
 */
function(t){Object.keys(t.$__.activePaths.states.require).forEach(function(e){var r=t.schema.path(e);null!=r&&"function"==typeof r.originalRequiredValue&&(t.$__.cachedRequired[e]=r.originalRequiredValue.call(t))})}(t);var i=Object.keys(t.$__.activePaths.states.require).filter(function(e){return!(!t.isSelected(e)&&!t.isModified(e))&&(!(e in t.$__.cachedRequired)||t.$__.cachedRequired[e])});i=(i=(i=i.concat(Object.keys(t.$__.activePaths.states.init))).concat(Object.keys(t.$__.activePaths.states.modify))).concat(Object.keys(t.$__.activePaths.states.default));var o=t.$__getAllSubdocs(),s=void 0;r=o.length;var a=t.modifiedPaths();for(e=0;e<r;++e)(s=o[e]).$basePath&&t.isModified(s.$basePath,a)&&!t.isDirectModified(s.$basePath)&&!t.$isDefault(s.$basePath)&&((i=i.filter(function(t){return null!=t&&0!==t.indexOf(s.$basePath+".")})).push(s.$basePath),n[s.$basePath]=!0);for(r=i.length,e=0;e<r;++e){var u=i[e],c=t.schema.path(u);if(c&&c.$isMongooseArray&&(!c.$isMongooseDocumentArray||O(c,"schemaOptions.required")))l(t.$__getValue(u),i,u)}function l(t,e,r){if(null!=t)for(var n=t.length,i=0;i<n;++i)Array.isArray(t[i])?l(t[i],e,r+"."+i):e.push(r+"."+i)}var f={skipArrays:!0};for(r=i.length,e=0;e<r;++e){var h=i[e];if(t.schema.nested[h]){var p=t.$__getValue(h);B(p)&&(p=p.toObject({transform:!1}));var d=w(p,h,f,t.schema);i=i.concat(Object.keys(d))}}for(r=(i=i.filter(function(e){return!t.schema.singleNestedPaths.hasOwnProperty(e)})).length,e=0;e<r;++e){var y=i[e],_=t.schema.path(y);if(_&&_.$isSchemaMap){var v=t.$__getValue(y);if(null!=v){var m=!0,g=!1,b=void 0;try{for(var S,A=v.keys()[Symbol.iterator]();!(m=(S=A.next()).done);m=!0){var E=S.value;i.push(y+"."+E)}}catch(t){g=!0,b=t}finally{try{!m&&A.return&&A.return()}finally{if(g)throw b}}}}}return[i=Array.from(new Set(i)),n]}
/*!
 * ignore
 */
/*!
 ...
 * ignore
 */
function e(r,n,i,o){var u=void 0;u=r&&s.isMongooseObject(r)&&!t.isBuffer(r)?Object.keys(r.toObject({transform:!1,virtuals:!1})):Object.keys(r||{});var c=u.length;var l={};n=n?n+".":"";for(var f=0;f<c;++f){var h=u[f],p=r[h];l[n+h]=p;var d=o&&o.path&&o.path(n+h),y=o&&o.nested&&o.nested[n+h];if(!d||"Mixed"!==d.instance){if(a(p)){if(i&&i.skipArrays&&Array.isArray(p))continue;var _=e(p,n+h,i,o);for(var v in _)l[v]=_[v];Array.isArray(p)&&(l[n+h]=p)}if(y){var m=Object.keys(o.paths),g=!0,b=!1,w=void 0;try{for(var O,S=m[Symbol.iterator]();!(g=(O=S.next()).done);g=!0){var A=O.value;A.startsWith(n+h+".")&&!l.hasOwnProperty(A)&&(l[A]=void 0)}}catch(t){b=!0,w=t}finally{try{!g&&S.return&&S.return()}finally{if(b)throw w}}}}}return l}
/*!
 * ignore
